  ...
  return (
    <section className="container" id="governance">
      <div className="prose">
        ...
        <h2>Governance</h2>
        <div className="grid">
          <Callout title="PII coverage:" description="high‑fidelity masking at rest & in transit." />
          <Callout title="Eval reliability:" description="tight variance on gold‑sets; decision‑linked metrics." />
          <Callout title="Review SLA:" description="sub‑day human loop with audit trails." />
          <Callout title="Drift:" description="streaming telemetry with safe rollback." />
        </div>
