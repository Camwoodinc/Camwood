    ...
    <section className="container" id="outcomes">
      <div className="prose">
        ...
        <div className="grid" id="stats">
          <Callout title="Time‑to‑decision:" description={<span data-count="42">0</span> + '% faster'} />
          <Callout title="Cost‑to‑serve:" description={<span data-count="28">0</span> + '% lower'} />
          <Callout title="Accuracy @ constraints:" description={<span data-count="17">0</span> + ' pt gain'} />
          <Callout title="Trust/CSAT:" description={<span data-count="22">0</span> + '% lift'} />
        </div>
        <figure className="illus" role="img" aria-label="Sparkline of improvement with annotations">
          ...
          <div className="canvas">
            <svg viewBox="0 0 800 220" preserveAspectRatio="none">
              <polyline id="spark" points="0,180 80,176 160,168 240,150 320,138 400,120 480,110 560,98 640,86 720,72 800,64" fill="none" stroke="#3fbf7f" strokeWidth="3" />
              <g fill="var(--color-text-muted)" fontSize="12">
                <text x="60" y="194">Baseline</text>
                <text x="360" y="134">Right‑size & govern</text>
                <text x="700" y="84">Human loop & evals</text>
              </g>
            </svg>
          </div>
